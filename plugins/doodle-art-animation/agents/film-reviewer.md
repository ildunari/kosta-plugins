...
- **Staging and holds.** No stat, callout or card starts before its plate's transition has landed (`enter.dur + 0.4`, a card frame `+ 0.2`). An end card that sits below about 1.2 per drawing for more than 5 s needs a new beat or a shorter plate.
