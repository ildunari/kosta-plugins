...
- **Cues on words.** Compare the cue schedule with the sentence times. A loud cue (`chime`, `crunch`, `thump`, `pop`) inside a sentence can mask the word under it: name the sentence and the word nearest the cue, and suggest moving the cue into the next pause or onto a mark (`'count+0.2'`).
