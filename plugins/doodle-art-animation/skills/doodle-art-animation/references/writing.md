...
| II | Inside the Drop (night) | 6.5 | lensIn 0.55 | push 7% + slow turn | … | jiggling centre | 0.1 molecules stagger · 0.6 bonds flicker · 1.6→5.0 stat · 3.8→ callout | … | 02 LIQUID | pitched plinks |
| III | The Cloud Within (night) | 5 | zoom out k 8 | push + rise | … | fixed | droplets drift on an updraft · 1.3 stat 20 µm | … | 03 CLOUD | glide, updraft hum |
