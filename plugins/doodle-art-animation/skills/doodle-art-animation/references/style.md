...
| `blueprint` | `whiteprint` | `blueprint` | `toolkit/grounds/`; devices and processes (see Choosing the paper set) |
| `lab` | `graph` | `fluorescence` | `toolkit/grounds/`; cell and molecular work (see Choosing the paper set) |
| `engineering` | `graphgreen` | `fluorescence` | `toolkit/grounds/`; the lab set with a greener pad |
...
| History of science, discovery stories | `codex` | laid paper / star atlas |
| Lecture-style shorts | `chalk` | whiteboard / chalkboard |
| Warm, hand-made, craft or personal stories | `toned` | kraft / black sketchbook |
