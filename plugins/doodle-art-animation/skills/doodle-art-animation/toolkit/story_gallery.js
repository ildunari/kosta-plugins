...
const SETTLE_A = {
  dur: DUR, cam: FLOAT(7), enter: { type: 'wipe', dur: 0.8 }, header: header(7, 'Settle kit · shelter', 'house, hut, tent, tower, cart, ship'),
  draw(t) {
...
const SETTLE_B = {
  dur: DUR, cam: FLOAT(8), enter: { type: 'zoom', dur: 0.9 }, header: header(8, 'Settle kit · land and routes', 'village, skyline, road, bridge, fields, market, map, ruins'),
  draw(t) {
...
defineStory({ title: 'Component Gallery', stages: 8, music: { tonic: 220 }, plates: [EARTH, TECH, AI, SPACE, LAB, STUDIO, SETTLE_A, SETTLE_B] });
boot();
