...
/*
 * New in v0.16.5 (sound build S2): writing tools for each paper, paper and desk sounds, data sounds, lab and body sounds,
...
const BED = {
  ...
  /* ---- new in v0.16.5 (sound build S2): settings for body, water, nature, time and the micro world ---- */
