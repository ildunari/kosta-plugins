...
| Gate 1 · Plan review | `script.md` on disk | a reviewed plan the user has seen | during the wait: folder, `helpers.js`, sound plan, and the voice audition for a narrated film |
